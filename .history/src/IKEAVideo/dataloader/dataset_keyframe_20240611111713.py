...
class KeyframeDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx, frame_idx=None):
        ...
        if frame_idx is None:
            ...
            end_idx = min(len(video_frames), frame_idx + 1)
            # If frame_idx is not provided, return information for the full video
           

        # If frame_idx is provided, return information for the specified frame
        ...
        sample = {
            ...
            "frame_meta": frame_data['meta'],
            "video_id": video_id,
            "is_frame_after_keyframe": is_frame_after_keyframe
        }
        ...
        if self.return_obj_paths:
            ...
            sample["obj_paths"] = frame_obj_paths
            sample["parts"] = frame_data['frame_parts']
