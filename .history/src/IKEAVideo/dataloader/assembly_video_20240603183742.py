...
def load_annotation(annotation_file, sort_frames_by_time=True, verbose=False):
    ...
    for furniture_d in tqdm(data, desc="Loading annotation"):
        ...
        # important: each video can have multiple different furnitures
        # for video_url in video_urls:
        #     if video_url not in video_url_to_category_name:
        #         video_url_to_category_name[video_url] = (category, name)
        #     else:
        #         assert video_url_to_category_name[video_url] == (category, name), f"video_url {video_url} has different category and name {video_url_to_category_name[video_url]}: ({category}, {name})"
        ...
        for step_d in steps:
            ...
            for step_video_d in step_videos:
                ...
                for frame_d in frames:
                    ...
                    # frame_connections = frame_d['connections']
