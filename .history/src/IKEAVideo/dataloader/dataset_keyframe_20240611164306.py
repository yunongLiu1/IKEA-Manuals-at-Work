        ...
        for f, frame_data in enumerate(video_frames):
            ...
            if self.debug:
                ...
                for i, mask in enumerate(decoded_masks):
                    ...
                    print(f"Color ID: {color_id} for part {frame_data['frame_parts'][i]}")
                ...
                # Display the image with overlay masks
                plt.figure(figsize=(8, 6))
                ...
                for i, mask in enumerate(decoded_masks):
                    ...
                    print(f"Color ID: {color_id} for part {frame_data['manual']['parts'][i]}")
                    color = colors[color_id % len(colors)]
